...
| Combined IMPORT+CALL impact | EXP-CALLS-IMPACT-0001 | High risk of false certainty | Explicit dual-axis only if labeled | `impact along imports,calls` | **NEEDS EVIDENCE** |
